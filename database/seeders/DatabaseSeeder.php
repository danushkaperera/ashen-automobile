...
class DatabaseSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $settings = [
            ...
            'plus_code' => ['', 'contact', 'text'],
            'facebook' => ['', 'social', 'text'],
            'instagram' => ['', 'social', 'text'],
            'youtube' => ['', 'social', 'text'],
            'twitter' => ['', 'social', 'text'],
            'primary_color' => ['#4BA8E8', 'appearance', 'color'],
            'secondary_color' => ['#002856', 'appearance', 'color'],
            'accent_color' => ['#7DD3FC', 'appearance', 'color'],
            'background_color' => ['#E8F4FC', 'appearance', 'color'],
            'surface_color' => ['#ffffff', 'appearance', 'color'],
            'text_color' => ['#002856', 'appearance', 'color'],
        ...
        Page::query()->updateOrCreate(
            ...
            [
                ...
                'content' => '<p><strong>Auto Bridge</strong> is a car repair shop in Middleton, Christchurch.</p><p><strong>Address:</strong> 11a Midas Place, Middleton, Christchurch 8024, New Zealand<br><strong>Phone:</strong> <a href="tel:+642902016792">+64 29 020 16792</a><br><strong>Hours:</strong> Open 24 hours<br><strong>Category:</strong> Car repair shop · Wheelchair accessible</p><p><a href="https://www.google.com/maps/place/Auto+Bridge/@-43.5419295,172.5818326,553m/data=!3m1!1e3!4m6!3m5!1s0x6d31f559b16c7ad1:0x51f12fe80e2e3e07!8m2!3d-43.5419295!4d172.5818326!16s%2Fg%2F11y_gwd7lm?entry=ttu&g_ep=EgoyMDI2MDkxNS4wIKXMDSoASAFQAw%3D%3D" target="_blank" rel="noopener">Open in Google Maps</a></p><p>Services: diagnostics and repairs, EV &amp; hybrid specialists, and pre-purchase inspections. We do not offer WOF inspections.</p>',
            ]
        );
